...
public class CommentActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void requestCommentList()
    {
        ...
        CommentClient.getComment(mStore.id, mStartIdx + "", "30", Const.POS_STORE, new Client.Handler() {
            @Override
    ...
    private void requestInsertComment()
    {
        ...
        CommentClient.insertComment(Global.getLoginUser().getId(), mStore.id, content, Const.POS_STORE, new Client.Handler() {
            @Override
            public void onSuccess(Object object) {
                mStartIdx = 0;
                requestCommentList();
